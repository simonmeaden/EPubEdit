...
bool
EPubDocument::parseDocument(const QString& filename)
{
...
bool
EPubDocument::parsePackageFile(QString& fullpath, QuaZip* archive)
{
...
SpineItem
EPubDocument::parseSpineItem(const QDomNode& spine_node, SpineItem item)
{
...
void
EPubDocument::extractHeadInformationFromHtmlFile(ManifestItem item,
                                                 QString container)
{
  QDomDocument doc;
