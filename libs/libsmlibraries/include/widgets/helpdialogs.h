 ...
 * simple dialog to show a small amount of help and don't not require the
...
//! \class BaseHelpDialog helpdialogs.h
...
public:
  ...
  //! Constructor for BaseHelpDialog
...
protected:
  //! label for all dialogs
  QTextEdit* m_primaryLbl;

  //! Calculates the minimum required width for supplied text
  //! after splitting at line breaks.
...
class SimpleHelpDialog : public BaseHelpDialog
{
  Q_OBJECT
public:
  //! Constructor for SimpleHelpDialog
...
class ExtendedHelpDialog : public BaseHelpDialog
{
  Q_OBJECT
public:
  //! Constructor for ExtendedHelpDialog
...
class ExtendedHelpWithTabsDialog : public BaseHelpDialog
{
  Q_OBJECT
public:
  //! Constructor for ExtendedHelpWithTabsDialog
...
class ExtendedHelpWithComboDialog : public BaseHelpDialog
{
  Q_OBJECT
public:
  //! Constructor for ExtendedHelpWithComboDialog
