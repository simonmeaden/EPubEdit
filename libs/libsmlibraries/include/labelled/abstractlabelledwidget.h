...
signals:
  //! signal sent when the label text is changed.
  void labelTextChanged(const QString& text);
  //! signal sent when the format of the label text is changed.
  void labelTextFormatChanged(Qt::TextFormat format);
  //! signal sent when the label alignment is changed.
  void labelAlignmentChanged(Qt::Alignment alignment);
  //! signal sent when the label position is changed.
