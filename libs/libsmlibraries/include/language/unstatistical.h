...
public:
  ...
  //! \brief Returns a QVector<QString> containing all of the UN statistical named
  //! areas.
  QVector<QString> names(Language lang);
...
private:
  QVector<int> M49CODES;
  QVector<QString> ALPHA3CODES;
